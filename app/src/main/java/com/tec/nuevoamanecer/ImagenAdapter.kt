...
class ImagenAdapter(private val context: Context, private val userUID: String, private val categoria: String, private val imagenes: List<Imagen>) :
    ...
    inner class ImagenViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(imagen: Imagen) {
            ...
            val imagenRef = storage.child("Tablero/$userUID/$categoria/${imagen.id}")
