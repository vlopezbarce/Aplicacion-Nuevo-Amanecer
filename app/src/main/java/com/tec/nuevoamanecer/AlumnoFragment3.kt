        ...
        botones.forEachIndexed { index, btnJuego ->
            btnJuego.setOnClickListener {
                val actionId = when (index) {
                    0 -> R.id.action_alumnoFragment3_to_game1Fragment
                    1 -> R.id.action_alumnoFragment3_to_game2Fragment
                    2 -> R.id.action_alumnoFragment3_to_game3Fragment
                    3 -> R.id.action_alumnoFragment3_to_game4Fragment
                    4 -> R.id.action_alumnoFragment3_to_game5Fragment
                    5 -> R.id.action_alumnoFragment3_to_game6Fragment
                    else -> R.id.action_alumnoFragment3_to_mainFragment
                }
